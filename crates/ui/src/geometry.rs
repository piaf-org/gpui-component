...
mod tests {
    ...
    fn test_placement() {
        ...
        assert_eq!(serde_json::to_string(&Placement::Bottom).unwrap(), r#""bottom""#);
        assert_eq!(serde_json::to_string(&Placement::Left).unwrap(), r#""left""#);
        assert_eq!(serde_json::to_string(&Placement::Right).unwrap(), r#""right""#);

        assert_eq!(serde_json::from_str::<Placement>(r#""top""#).unwrap(), Placement::Top);
        assert_eq!(serde_json::from_str::<Placement>(r#""bottom""#).unwrap(), Placement::Bottom);
        assert_eq!(serde_json::from_str::<Placement>(r#""left""#).unwrap(), Placement::Left);
        assert_eq!(serde_json::from_str::<Placement>(r#""right""#).unwrap(), Placement::Right);
    }
    ...
    fn test_side() {
        ...
        assert_eq!(serde_json::from_str::<Side>(r#""right""#).unwrap(), Side::Right);
    }
}
